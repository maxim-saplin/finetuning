...
from data import DpoDatasetOptions, add_own_dpo, filter_out_large_dpo, get_dpo_dataset
...
def main():
    def get_clean_dataset(max_tokens, tokenizer):
        dataset = get_dpo_dataset(tokenizer, DpoDatasetOptions.ULTRAFEEDBACK)
